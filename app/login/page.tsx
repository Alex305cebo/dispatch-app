...
export default async function LoginPage() {
  ...
  // Аварийный сброс админа переменной окружения — последний рубеж, когда пароль
  // забыт и кода восстановления нет. См. lib/install.ts.
  if (installed) await applyAdminReset()
