      ...
      {open &&
        ...
        createPortal(
          <span
            ...
            className="pointer-events-none z-[100] rounded-lg border border-white/15 bg-ink-800 px-3 py-2 text-xs font-normal normal-case leading-relaxed tracking-normal text-t1 shadow-xl"
          >
            {text}
          </span>,
          document.body,
