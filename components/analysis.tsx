      ...
      <details className="group mt-4">
        ...
        <div className="mt-5 border-t border-white/8 pt-3">
          ...
          <CostBar
            ...
            gross={r.gross}
            color="bg-white/40"
            hint="Постоянные расходы трака за день (платёж за трак, страховка, ELD, пермиты, плейты) × дни в пути. Тратятся, даже когда трак стоит. Сумму за день меняешь в «Расходы трака», число дней — в Деталях."
          />
          {r.factoring > 0 && (
            <CostBar
              label="Факторинг"
