...
export const telegramDict = {
  ...
  // Инструкции на странице Telegram, когда он недоступен
  'telegram.help.noAccessTitle': {
    ru: 'Telegram у тебя пока не включён',
    en: 'Telegram is not enabled for you yet',
    es: 'Telegram aún no está activado para ti',
    uk: 'Telegram у тебе поки не ввімкнено',
    ro: 'Telegram nu e încă activat pentru tine',
    kk: 'Сізде Telegram әлі қосылмаған',
  },
  'telegram.help.demoTitle': {
    ru: 'В демо Telegram не подключается',
    en: 'Telegram cannot be connected in the demo',
    es: 'En la demo no se puede conectar Telegram',
    uk: 'У демо Telegram не підключається',
    ro: 'În demo Telegram nu se poate conecta',
    kk: 'Демода Telegram қосылмайды',
  },
  'telegram.help.what': {
    ru: 'Здесь переписка с водителями через твой Telegram: фото BOL/POD из чата сами прикрепляются к грузу.',
    en: 'This is where you chat with drivers through your Telegram: BOL/POD photos from the chat attach to the load automatically.',
    es: 'Aquí chateas con los conductores por tu Telegram: las fotos BOL/POD del chat se adjuntan solas a la carga.',
    uk: 'Тут листування з водіями через твій Telegram: фото BOL/POD з чату самі прикріплюються до вантажу.',
    ro: 'Aici discuți cu șoferii prin Telegramul tău: pozele BOL/POD din chat se atașează singure la cursă.',
    kk: 'Мұнда жүргізушілермен сіздің Telegram арқылы хат алысасыз: чаттағы BOL/POD суреттері жүкке өзі тіркеледі.',
  },
  'telegram.help.step1': {
    ru: 'Попроси администратора открыть Админку → «Пользователи и права».',
    en: 'Ask an admin to open Admin → “Users and permissions”.',
    es: 'Pide a un administrador que abra Admin → «Usuarios y permisos».',
    uk: 'Попроси адміністратора відкрити Адмінку → «Користувачі і права».',
    ro: 'Roagă un administrator să deschidă Admin → „Utilizatori și permisiuni”.',
    kk: 'Әкімшіден Әкімші панелі → «Пайдаланушылар және құқықтар» бөлімін ашуды сұраңыз.',
  },
  'telegram.help.step2': {
    ru: 'В твоей строке он включает переключатель «Telegram».',
    en: 'In your row they switch on “Telegram”.',
    es: 'En tu fila activa el interruptor «Telegram».',
    uk: 'У твоєму рядку він вмикає перемикач «Telegram».',
    ro: 'Pe rândul tău activează comutatorul „Telegram”.',
    kk: 'Сіздің жолыңызда «Telegram» ауыстырғышын қосады.',
  },
  'telegram.help.step3': {
    ru: 'Обнови эту страницу — появится подключение: api_id, api_hash и код из Telegram, по шагам.',
    en: 'Refresh this page — the connect steps appear: api_id, api_hash and the code from Telegram.',
    es: 'Recarga esta página — aparecerán los pasos: api_id, api_hash y el código de Telegram.',
    uk: 'Онови цю сторінку — з’явиться підключення: api_id, api_hash і код із Telegram, покроково.',
    ro: 'Reîncarcă pagina — apar pașii de conectare: api_id, api_hash și codul din Telegram.',
    kk: 'Бетті жаңартыңыз — қосу қадамдары шығады: api_id, api_hash және Telegram коды.',
  },
  'telegram.help.demoText': {
    ru: 'Демо — общий аккаунт с выдуманными данными, личный Telegram к нему не привязать. Войди в свой аккаунт, и здесь будет пошаговое подключение.',
    en: 'The demo is a shared account with made-up data — a personal Telegram can’t be attached to it. Sign in to your own account and step-by-step setup appears here.',
    es: 'La demo es una cuenta compartida con datos inventados — no se le puede vincular un Telegram personal. Entra en tu cuenta y aquí verás la conexión paso a paso.',
    uk: 'Демо — спільний акаунт із вигаданими даними, особистий Telegram до нього не прив’язати. Увійди у свій акаунт, і тут буде покрокове підключення.',
    ro: 'Demo e un cont comun cu date inventate — nu i se poate lega un Telegram personal. Intră în contul tău și aici apare conectarea pas cu pas.',
    kk: 'Демо — ойдан шығарылған деректері бар ортақ аккаунт, оған жеке Telegram байланбайды. Өз аккаунтыңызға кіріңіз, мұнда қадамдап қосу шығады.',
  },
  'telegram.help.login': {
    ru: 'Войти в свой аккаунт',
    en: 'Sign in to your account',
    es: 'Entrar en mi cuenta',
    uk: 'Увійти у свій акаунт',
    ro: 'Intră în contul tău',
    kk: 'Өз аккаунтыңызға кіру',
  },
  ...
  'telegram.page.noTruckChat': {
    ru: 'Чат водителя этого трака не найден. Привяжите чат к траку в «Какие чаты показывать» ниже (выбор трака справа от чата) или впишите телефон водителя в паспорт трака.',
    en: 'No chat found for this truck’s driver. Link a chat to the truck in the chat settings below (truck picker next to the chat) or add the driver’s phone to the truck profile.',
    es: 'No se encontró el chat del conductor de este camión. Vincula un chat al camión en los ajustes de chats abajo o añade el teléfono del conductor al perfil del camión.',
    uk: 'Чат водія цього трака не знайдено. Прив’яжіть чат до трака в налаштуваннях чатів нижче або впишіть телефон водія в паспорт трака.',
    ro: 'Nu s-a găsit chatul șoferului acestui camion. Leagă un chat de camion în setările de mai jos sau adaugă telefonul șoferului în profilul camionului.',
    kk: 'Осы тракт жүргізушісінің чаты табылмады. Төмендегі чат баптауларында чатты трактқа байлаңыз немесе жүргізуші телефонын тракт паспортына жазыңыз.',
  },
  ...
  'telegram.attach.pickTruckTitle': { ru: 'К какому траку этот чат?', en: 'Which truck is this chat?', es: '¿De qué camión es este chat?', uk: 'До якого трака цей чат?', ro: 'Al cărui camion e acest chat?', kk: 'Бұл чат қай тракқа тиесілі?' },
  'telegram.attach.pickTruckHint': { ru: 'Выбери один раз — дальше бумаги из этого чата сразу пойдут в грузы этого трака.', en: 'Pick once — from then on papers from this chat go straight to that truck loads.', es: 'Elige una vez: desde entonces los papeles de este chat irán directo a las cargas de ese camión.', uk: 'Обери один раз — далі папери з цього чату одразу підуть у вантажі цього трака.', ro: 'Alege o dată — de acum actele din acest chat merg direct la cursele camionului.', kk: 'Бір рет таңда — осы чаттағы құжаттар бірден сол тракт жүктеріне түседі.' },
  'telegram.attach.pickTruckCancel': { ru: 'Не сейчас', en: 'Not now', es: 'Ahora no', uk: 'Не зараз', ro: 'Nu acum', kk: 'Қазір емес' },
  'telegram.attach.linked': { ru: 'Чат привязан к траку {truck}', en: 'Chat linked to truck {truck}', es: 'Chat vinculado al camión {truck}', uk: 'Чат прив’язано до трака {truck}', ro: 'Chat legat de camionul {truck}', kk: 'Чат {truck} тракқа байланды' },
