...
export const tollsDict = {
  ...
  'tolls.fullCostHint': {
    ru: 'толлы плюс топливо и обслуживание на пробег',
    en: 'tolls plus fuel and maintenance for the miles',
  },
  'tolls.vsBest': { ru: 'дороже лучшего на {v}', en: '{v} more than the best' },
  'tolls.isBest': { ru: 'лучший по полной стоимости', en: 'best by total cost' },
