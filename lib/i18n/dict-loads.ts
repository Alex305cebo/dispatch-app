...
export const loadsDict = {
  ...
  'loads.search.clear': { ru: 'Очистить поиск', en: 'Clear search' },
  'loads.filter.all': { ru: 'Все', en: 'All' },
  'loads.filter.losing': { ru: 'В убыток', en: 'Losing money' },
  'loads.filter.uninvoiced': { ru: 'Счёт не выставлен', en: 'Not invoiced' },
  'loads.filter.unpaid': { ru: 'Не оплачены', en: 'Unpaid' },
  'loads.filter.noPod': { ru: 'Нет POD', en: 'No POD' },
  'loads.filter.shownOf': { ru: '{n} из {total}', en: '{n} of {total}' },
  ...
  'loads.sort.newest': { ru: 'Сначала новые', en: 'Newest first' },
  'loads.sort.rate': { ru: 'По ставке', en: 'By rate' },
  'loads.sort.rpm': { ru: 'По ставке за милю', en: 'By rate per mile' },
  'loads.sort.net': { ru: 'По чистой', en: 'By net' },
  'loads.export.title': {
  ...
  'loadForm.deadheadLabel': { ru: 'Deadhead', en: 'Deadhead miles' },
  ...
  'loadEdit.deadheadMiles': { ru: 'Deadhead', en: 'Deadhead miles' },
  ...
  'analysis.deadhead': { ru: 'Deadhead', en: 'Deadhead' },
