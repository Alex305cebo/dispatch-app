...
export const docsDict = {
  ...
  'docs.sub.fleet': {
    ...
    en: "Every driver's paperwork: their loads, insurance, registration, receipts, photos.",
    es: 'Todos los papeles de cada conductor: sus cargas, seguro, registro, recibos, fotos.',
    uk: 'Усі папери кожного водія: його вантажі, страховка, реєстрація, чеки, фото.',
    ro: 'Toate hârtiile fiecărui șofer: cursele lui, asigurare, înmatriculare, bonuri, poze.',
    kk: 'Әр жүргізушінің барлық қағазы: жүктері, сақтандыру, тіркеу, чектер, фото.',
  },
  'docs.sub.trash': {
  ...
  'docs.library.noPapers': { ru: 'Бумаг пока нет', en: 'No papers yet', es: 'Aún no hay documentos', uk: 'Паперів поки немає', ro: 'Încă nu sunt documente', kk: 'Әзірге құжат жоқ' },
  'docs.library.own': { ru: 'Трак и водитель', en: 'Truck & driver', es: 'Camión y conductor', uk: 'Трак і водій', ro: 'Camion și șofer', kk: 'Тракт пен жүргізуші' },
  'docs.library.loads': { ru: 'Грузы', en: 'Loads', es: 'Cargas', uk: 'Вантажі', ro: 'Curse', kk: 'Жүктер' },
  'docs.library.moreLoads': { ru: 'ещё грузов: {n}', en: '{n} more loads', es: '{n} cargas más', uk: 'ще вантажів: {n}', ro: 'încă {n} curse', kk: 'тағы {n} жүк' },
  'docs.library.files': { ru: 'файлов: {n}', en: 'files: {n}', es: 'archivos: {n}', uk: 'файлів: {n}', ro: 'fișiere: {n}', kk: 'файл: {n}' },
  'docs.library.summary': { ru: 'грузов: {loads} · своих бумаг: {own}', en: 'loads: {loads} · own papers: {own}', es: 'cargas: {loads} · propios: {own}', uk: 'вантажів: {loads} · своїх паперів: {own}', ro: 'curse: {loads} · proprii: {own}', kk: 'жүк: {loads} · өз қағазы: {own}' },
  'docs.library.search': {
